...
'''
    ...
    description:
        ...
        - To convert frozen graph (.pb) to   tflite (.tflite) format

    references:
        - Related github:   https://github.com/tensorflow/tensorflow/blob/master/tensorflow/contrib/lite/toco/g3doc/cmdline_examples.md#savedmodel
            - freeze_graph.py       : https://github.com/tensorflow/tensorflow/blob/master/tensorflow/python/tools/freeze_graph.py
            - toco_from_protos.py   : https://github.com/tensorflow/tensorflow/tree/master/tensorflow/contrib/lite/toco


    author: Jaewook Kang
    final update date  : 2018 Apr
'''
...
class FreezeGraphConfig(object):
    ...
    def set_config(self, input_dir_path, input_pb_name, input_ckpt_name,
        ...
        split_input_pb_name = self.input_pb_name.split('.')

        if split_input_pb_name[-1] == 'pb':
            # pb case
            ...
            # pbtxt case
            self.output_pb_name = 'frozen_' + split_input_pb_name[0] + '.pb'
            self.binary_opt = False
